...
#SBATCH -A dayabay -C haswell -L project,projecta,SCRATCH -q shared -t 2:00:00
...
sleep $(( RANDOM % 100 ))       # so they don't all mob the lockfile at once on startup (400 jobs, staggered)
