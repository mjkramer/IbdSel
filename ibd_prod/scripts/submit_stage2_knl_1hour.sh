...
export IBDSEL_CHUNKSIZE=${IBDSEL_CHUNKSIZE:-25}

export IBDSEL_WALLTIME=${IBDSEL_WALLTIME:-01:00:00}
# previous chunk margin of 450 (== file margin) left us with some stragglers
export IBDSEL_CHUNK_MARGIN_SECS=${IBDSEL_CHUNK_MARGIN_SECS:-600}
export IBDSEL_FILE_MARGIN_SECS=${IBDSEL_FILE_MARGIN_SECS:-450}  # 90sec * 5
export IBDSEL_STARTUP_SLEEP_SECS=${IBDSEL_STARTUP_SLEEP_SECS:-60}
