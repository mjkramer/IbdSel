...
export IBDSEL_CHUNK_MARGIN_SECS=${IBDSEL_CHUNK_MARGIN_SECS:-250} # 50 * 1sec * 5
export IBDSEL_FILE_MARGIN_SECS=${IBDSEL_FILE_MARGIN_SECS:-150}  # 30sec * 5
export IBDSEL_STARTUP_SLEEP_SECS=${IBDSEL_STARTUP_SLEEP_SECS:-120}
export IBDSEL_NTASKS=${IBDSEL_NTASKS:-32}
